...
public class Config {
    ...
    static class ConfigValues {
        ...
        drive_max_speed = 4500,
        //    1=voltage, 2=speed
        control_mode = 2,
        drive_ratelimit_perTick = 900,
        drive_speed_modify = 0.5,
        //#end drive section
        
        //#shooter section
        angle_power = .75,
        angle_power_slow = 0.25,
        loader_power = -0.75,
        ...
        shooter_homing_turnaround_time = 2,
        shooter_homing_up_speed = 1,
        shooter_homing_down_speed = -1,
        shooter_angle_tolerance = 10,
        
        home_position_shaft_length = 9.5,
        crouch_angle = 10,
        
        wheel_deadzone = .03,
        
        //#### WHISBEE
        pyramid_shooting_angle = 22.5,
        shooter_loading_angle = 10,
        load_zone_shooting_angle = 14.25,
        ...
        shooter_secondary_speed = 2000,
        shooter_main_speed_pyramid = 2300,
        shooter_secondary_speed_pyramid = 2000,
        shooter_angle_bias = 0,
        
        //#Percentage
        shooter_front_wheel_manual = 1.0,
        shooter_rear_wheel_manual = 0.7,
        
        
        
        //#end shooter section
        
        target_camera_fov = 57,
        target_rotate_scale = .5,
        target_rotate_tolerance = 1,
        
        //#Autonomous section
        autoProgram = 1,
        auto_spinup_delay = 2.0,
        //auto_Front_Wheel_Speed = 4500, //original 4-20-13
        //auto_Rear_Wheel_Speed = 3000, //original 4-20-13
        auto_Front_Wheel_Speed = 4000,
        auto_Rear_Wheel_Speed = 2500,
        auto_Shooter_Tolerance = 200,
        auto_delay = 1,
        auto_angle = 22.5,
        //auto_angle = 22.75,
